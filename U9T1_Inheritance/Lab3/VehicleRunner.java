...
public class VehicleRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Toll Price: " + vehicle.calculateTollPrice());
        ...
        System.out.println("Toll Price: " + car.calculateTollPrice());
        ...
        System.out.println("Toll Price: " + truck.calculateTollPrice());
        ...
        taxi.printTaxi();
        System.out.println("Toll Price: " + taxi.calculateTollPrice());
        ...
        System.out.println("Fare Collected: " + taxi.getFareCollected());
        taxi.printCar();
